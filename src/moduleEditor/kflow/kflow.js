								...
								if(infoJson.interface && infoJson.interface.fields){
									Object.keys(infoJson.interface.fields).forEach((key) => {
										...
										if(currentField.fieldType === 'module'){
											...
											finalizeExtraValues[key] = [
												// TODO: 定義されたサブモジュールの情報を取得して、ダミーコンテンツを生成する
												{
													label: 'Dummy test 1.',
												},
												{
